"""
Well-tempered metadynamics of alanine dipeptide in water, biased on the per-atom
...
def get_args(argv):
    ...
    available_args = [
        ...
        ("width", "w", float, 1.0, "Width of gaussian bias"),
        ("deltaT", "dT", float, 5000, "DeltaT for well-tempered metadynamics"),
        ("stride", "s", int, 1000, "Frequency of adding gaussian bias"),
