...
refer = read(f'unbiased/{args.temperature}K_{args.pressure}bar.traj', index=':', format='lammps-dump-text')[50:]
...
def main(argv):
    ...
    cache = initialize_cache(f'structure/Cu_half_{temperature}K_{pressure}bar.lmp')
